...
import AdminInsertBatch from '@/components/AdminInsertBatch'
...
import RichTextEditer from '@/components/learn/RichTextEditer'
...
export default new Router({
  ...
  routes: [
    ...
    {path: '/textedit',component:RichTextEditer},
    ...
    {path: '/typeBatchAdd',component: AdminInsertBatch},
